...
def get_engine():
    ...
    print "get me eng"
    engine = get_sapi5_inproc_engine()
    if engine:
        return engine
...
def get_sapi5_inproc_engine():
    ...
    import dragonfly.engines.engine_sapi5_inproc as engine_sapi5
    Sapi5Engine = engine_sapi5.Sapi5InprocEngine
    if Sapi5Engine.is_available():
        _sapi5_engine = Sapi5Engine()
        _engine = _sapi5_engine
        return _sapi5_engine
